          ...
          <section className='home-hero-section relative overflow-hidden border-b border-semi-color-border'>
            ...
            <div className='home-tech-bg' aria-hidden='true'>
              ...
              <div className='home-tech-code' aria-hidden='true'>
                ...
                <div className='home-code-line'><span className='home-code-no'>10</span><span>{'      '}<span className='home-code-key'>"content"</span><span className='home-code-punc'>:</span>{' '}<span className='home-code-string'>"你好，请介绍一下你自己。"</span></span></div>
